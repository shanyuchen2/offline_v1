...
insert overwrite table dws_trade_user_order_1d partition(dt='20250917')
select
    user_id,
    count(distinct(order_id)),
    sum(sku_num),
...
insert overwrite table dws_trade_user_cart_add_1d partition(dt='20250917')
select
    user_id,
    count(*),
    sum(sku_num)
...
insert overwrite table dws_trade_user_payment_1d partition(dt='20250917')
select
    user_id,
    count(distinct(order_id)),
    sum(sku_num),
...
insert overwrite table dws_trade_province_order_1d partition(dt='20250917')
select
    province_id,
    province_name,
    area_code,
...
insert overwrite table dws_tool_user_coupon_coupon_used_1d partition(dt='20250917')
select
    user_id,
    coupon_id,
    coupon_name,
...
insert overwrite table dws_interaction_sku_favor_add_1d partition(dt='20250917')
select
    sku_id,
    sku_name,
    category1_id,
...
insert overwrite table dws_trade_user_sku_order_nd partition(dt='20250916')
select
    user_id,
    sku_id,
    sku_name,
